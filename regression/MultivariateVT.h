...
class MultivariateVT {
 public:
   ...
   */
  int compute(Vector& freq, Matrix& U, Matrix& V);

  double getMinMAF() const { return this->minMAF; }
  double getMaxMAF() const { return this->maxMAF; }
  double getOptimalMAF() const { return this->optimalMAF; }
  int getOptimalNumVar() const { return this->optimalNumVar; }
  double getOptimalU() const { return this->optimalU; }
  double getOptimalV() const { return this->optimalV; }
