...
int LogisticRegressionVT::GetIndexMax() { return this->impl->GetIndexMax(); };

Matrix& LogisticRegressionVT::GetU() { return this->impl->GetU(); };

Matrix& LogisticRegressionVT::GetV() { return this->impl->GetV(); };

Matrix& LogisticRegressionVT::GetT() { return this->impl->GetT(); };

Matrix& LogisticRegressionVT::GetCov() { return this->impl->GetCov(); };
...
Matrix& LogisticRegressionVT::LogisticVTImpl::GetU() { return this->retU; };

Matrix& LogisticRegressionVT::LogisticVTImpl::GetV() { return this->retV; };

Matrix& LogisticRegressionVT::LogisticVTImpl::GetT() { return this->retT; };

Matrix& LogisticRegressionVT::LogisticVTImpl::GetCov() { return this->retCov; };
