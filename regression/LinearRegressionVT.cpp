...
int LinearRegressionVT::GetIndexMax() { return this->impl->GetIndexMax(); };

Matrix& LinearRegressionVT::GetU() { return this->impl->GetU(); };

Matrix& LinearRegressionVT::GetV() { return this->impl->GetV(); };

Matrix& LinearRegressionVT::GetT() { return this->impl->GetT(); };

Matrix& LinearRegressionVT::GetCov() { return this->impl->GetCov(); };
...
int LinearRegressionVT::LinearVTImpl::GetIndexMax() { return this->maxIndex; };

Matrix& LinearRegressionVT::LinearVTImpl::GetU() { return this->retU; };

Matrix& LinearRegressionVT::LinearVTImpl::GetV() { return this->retV; };

Matrix& LinearRegressionVT::LinearVTImpl::GetT() { return this->retT; };

Matrix& LinearRegressionVT::LinearVTImpl::GetCov() { return this->retCov; };
