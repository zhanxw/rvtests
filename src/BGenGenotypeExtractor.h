#ifndef BGENGENOTYPEEXTRACTOR_H
#define BGENGENOTYPEEXTRACTOR_H
 ...
 * @return 0 if succeed
 */
// int loadMarkerFromBGEN(const std::string& fileName, const std::string&
// marker,
...
class BGenGenotypeExtractor : public GenotypeExtractor {
 ...
 private:
  BGenGenotypeExtractor(const BGenGenotypeExtractor&);
  BGenGenotypeExtractor& operator=(const BGenGenotypeExtractor&);
 ...
 public:
  ...
  inline double getGenotype(const BGenVariant& var, int indvIdx,
                            const bool useDosage, const bool hemiRegion,
                            const int sex);
  double getGenotypeForAltAllele(const BGenVariant& var, int indvIdx,
                                 const bool useDosage, const bool hemiRegion,
                                 const int sex, const int alt);
...
};                                     // class BGenGenotypeExtractor

#endif /* BGENGENOTYPEEXTRACTOR_H */
