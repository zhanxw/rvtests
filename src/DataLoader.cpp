...
int DataLoader::orderSamples(const std::vector<std::string>& names,
...
int DataLoader::loadSex(const std::string pheno) {
  // load sex
  std::vector<int> sex;
...
int DataLoader::loadMarkerAsCovariate(const std::string marker) {
...
int loadCovariate(const std::string& fn,
  ...
  return loadCovariate(fn, includedSample, fd, handleMissingCov, covariate,
