...
class Table2by2 {
 public:
  ...
  void InitializeFromVecMat(Vector &yIn,
                            Matrix &xIn);  // here xIn is a nSample by 1 matrix
  ...
  double getPExactOneSidedGreater() const {
    return this->pExactOneSidedGreater;
  };
