...
public:
    ...
    void setRangeList(const char* s) {
        this->vin->setRangeList(s);
    }
    void setRangeFile(const char* s) {
        this->vin->setRangeFile(s);
    }
    void excludeAllPeople(const char* s) {
        this->vin->includePeople(s);
    }
    void includePeopleList(const char* s) {
        this->vin->excludeAllPeople();
    }
    void includePeopleFile(const char* s) {
        this->vin->includePeopleFromFile(s);
    }
    void excludePeople(const char* s) {
        this->vin->excludePeople(s);
    }
    void excludePeopleFile(const char* s) {
        this->vin->excludePeopleFromFile(s);    
    }
    void includeThenExclude(const char* incList,
                            const char* incFile,
                            const char* excList,
                            const char* excFile) {
        this->vin->excludeAllPeople();
        this->vin->includePeople(incList);
        this->vin->includePeopleFromFile(incFile);
        this->vin->excludePeople(excList);
        this->vin->excludePeopleFromFile(excFile);
    }
    ...
    const std::vector<std::string>& getPeopleId() { return this-> peopleId;};
